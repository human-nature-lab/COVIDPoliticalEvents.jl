# GUIDE:
# This code
# 1. extracts and cleans protest size estimates which are 
# initially located in the "NOTES" var
# 2. fixes missing fips entries
# 
# This data will then be joined to covid, demographic and other 
# relevant data
...
adf <- readr::read_csv("data/USA_2020_Oct10update.csv")
...
readr::write_csv(adf, file = "data/clean_protest_data.csv")